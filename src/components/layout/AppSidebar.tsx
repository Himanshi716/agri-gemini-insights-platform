...
const navigationItems = [
  ...
  { title: "Farm Management", url: "/farms", icon: Leaf },
  { title: "IoT Monitoring", url: "/iot", icon: Wifi },
  { title: "Compliance Center", url: "/compliance", icon: Shield },
  { title: "Export Documents", url: "/export", icon: FileText },
